...
from langchain_community.vectorstores import FAISS          # библиотека для работы с векторной базой FAISS
from langchain_openai import OpenAIEmbeddings               # класс для работы с вектроной базой
